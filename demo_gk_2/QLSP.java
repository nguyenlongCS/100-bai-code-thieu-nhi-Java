...
//        ds.add(sp);
//        try {
//            FileWriter f = new FileWriter("src/main/source/SanPham.txt", true);
...
//    }
    public void themSP(SanPham sp) {
        ds.add(sp);
        try (PrintWriter w = new PrintWriter(new FileWriter("src/main/source/SanPham.txt",
                true))) {
            w.print("\n" + sp);
            if (sp instanceof SanPhamKhuyenMai) {
                SanPhamKhuyenMai km = (SanPhamKhuyenMai) sp;
                w.print(", " + km.getGiaGiam());
            }
        } catch (IOException e) {
            System.out.println(e.getMessage());
        }
...
//    }
    public void top5() {
        sapXep();
        try (PrintWriter w = new PrintWriter("src/main/source/Top5.txt")) {
